...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 py-16 overflow-hidden">
      ...
      {/* Main Content */}
      <div className="relative z-10 flex flex-col justify-between items-center w-full max-w-3xl min-h-[70vh] lg:min-h-[80vh] mx-auto">
        ...
        <div className="flex-1 flex flex-col justify-center items-center">
          <h1 className="text-black leading-tight flex flex-col items-center gap-4">
            ...
            <span className="text-8xl md:text-8xl lg:text-9xl">
