          ...
          <h1 className="text-black leading-tight flex flex-col items-center gap-4">
            ...
            <span className="text-5xl md:text-7xl lg:text-9xl">
              <span className="relative inline-block">
                ...
                <span
                  className="absolute inset-0 z-10 font-work-sans font-semibold italic pointer-events-none"
                  style={{
                    WebkitTextStroke: '15px #FFFBEB',
                    color: 'transparent',
                    textShadow: `
                ...
                {/* Main text (on top) */}
                <span className="relative z-20 font-work-sans font-semibold italic text-black">
                  Everyone
                </span>
              </span>
              <EveryoneWavyUnderline className="pl-2 -mt-3" />
            </span>
            <span className="font-crimson font-medium text-4xl md:text-6xl lg:text-8xl">
              using this?
            </span>
